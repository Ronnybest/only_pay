...
abstract class UserRepository {
  ...
  Future<void> uploadPost(
      PostModel model, String collectionName, BuildContext context);
}

class ConnectAndRegistr implements UserRepository {
  @override
  Future<void> uploadPost(
      PostModel model, String collectionName, BuildContext context) async {
    var db = await MongoDB.connect();
    var collections = db.collection(collectionName);
    await MongoDB.insertPost(model, collections);
  }
